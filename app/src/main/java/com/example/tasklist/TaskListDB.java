...
public class TaskListDB {
    ...
    private static class DBHelper extends SQLiteOpenHelper{
        ...
        //onUpgrade method is used to drop & recreate the database
        @Override
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            Log.d("Task list", "Upgrading db from new version" + oldVersion + " to " + newVersion);
            db.execSQL(TaskListDB.DROP_LIST_TABLE);
            db.execSQL(TaskListDB.DROP_TASK_TABLE);
            onCreate(db); //create the new one
        }
    }
    ...
    //private methods to open & close database
